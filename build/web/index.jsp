<%-- 
    Document   : index
    Created on : 19/09/2020, 12:31:03 AM
    Author     : JonathanY
--%>
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-auto">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_pcosto" id="txt_pcosto" class="form-control"  required> 
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_pventa" id="txt_pventa" class="form-control" required> 
                </div>
                ...
                <input type="submit" class="btn btn-success" name="btn_agregar" id="btn_agregar" value="agregar" >
                <input type="submit" class="btn btn-primary" name="btn_modificar" id="btn_modificar"  value="modificar">
                <input type="submit" class="btn btn-secundary" name="btn_eliminar" id="btn_modificar" value="eliminar">
